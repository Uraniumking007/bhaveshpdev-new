export const portfolioData = {
  projects: [
    {
      ...
      description: 'Modern portfolio and blog built with Astro, TypeScript, and Tailwind CSS.',
      technologies: ['Astro', 'TypeScript', 'Tailwind'],
      codeUrl: 'https://github.com/UraniumKing007/portfolio',
      demoUrl: 'https://bhaveshpatil.dev'
    },
    {
      id: 2,
      title: 'Blog Platform',
      description: 'Full-featured blog with authentication, rich text editor, and scheduled publishing.',
      technologies: ['React', 'Node.js', 'PostgreSQL'],
      codeUrl: 'https://github.com/UraniumKing007/blog',
      demoUrl: 'https://blog.bhaveshpatil.dev'
    }
  ],
  ...
  skills: {
    frontend: ['React', 'TypeScript', 'JavaScript', 'Tailwind CSS', 'Astro', 'Next.js', 'HTML5', 'CSS3'],
    backend: ['Node.js', 'Python', 'Express', 'FastAPI', 'PostgreSQL', 'MongoDB', 'Redis', 'GraphQL'],
    devops: ['Git', 'Docker', 'Kubernetes', 'AWS', 'Vercel', 'CI/CD', 'Linux', 'Nginx']
  }
};
